document.addEventListener('DOMContentLoaded', () => {
    ...
    const sections = document.querySelectorAll('section:not(.projects):not(.roadmap)');
    ...
    // Scroll-based milestone card animation
    ...
    milestoneCards.forEach(card => {
        const header = card.querySelector('.milestone-header');
        const details = card.querySelector('.milestone-details');
        ['click', 'touchstart'].forEach(eventType => {
            header.addEventListener(eventType, debounce((e) => {
                e.preventDefault();
                milestoneCards.forEach(otherCard => {
                    const otherDetails = otherCard.querySelector('.milestone-details');
                    if (otherCard !== card) {
